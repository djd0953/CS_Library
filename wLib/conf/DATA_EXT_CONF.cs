...
namespace wLib
{
    ...
    {
        CONFIG config = new CONFIG("DATA_EXT.ini");
    ...
    public class DATA_EXT_ROW_CONF
    {
        CONFIG config = new CONFIG("DATA_EXT.ini");
        ...
        public string datatime_column_name = "lasttime";
        
        public int channel_count = 0;
        public CHANNEL_CONF[] channel = new CHANNEL_CONF[0];

        public DATA_EXT_ROW_CONF(string section = "EXT_ROW")
        {
            this.section = section;
        ...
        public bool ReadConfig()
        {
            ...
            if (config.LockMutex())
            {
                ...
                for (int i = 0; i < channel_count; i++)
                {
                    ...
                    temp = string.Format("CHANNEL_{0}_QUERY_WHERE", idx);
                    channel[i].QUERY_WHERE = config.ReadString(section, temp, channel[i].QUERY_WHERE);
