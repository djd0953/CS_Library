...
namespace wLib
{
    public class DPS_CONF
    {
        CONFIG config = new CONFIG("DPS.ini");
        ...
        public string db_table { get; set; } = "tb_caldata";

        public string st_code = "000";
        public int channel_count = 0;
        public CHANNEL_CONF[] channel = new CHANNEL_CONF[0];

        public DPS_CONF(string section = "DPS")
        {
        ...
        public bool ReadConfig()
        {
            ...
            if (config.LockMutex())
            {
                ...
                st_code = config.ReadString(section, "ST_CODE", st_code);
        ...
        public void SaveConfig()
        {
            ...
            if (config.LockMutex())
            {
                ...
                config.WriteString(section, "ST_CODE", st_code);
